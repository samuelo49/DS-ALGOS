...
Plan
- we want to only store teh chagnes of values for each key chronologically in its own array
...
- for thet get function, we ant to find the value stored in key at timestamp. in histories[key], it is the
    entry with the greatest timestamp less or equal to the given timestamp
