'''
❓ PROMPT
You are given four arrays representing two lists of operands, one list of operators, and a list of results.
For any index, i, your task is to check to see if:
...
# loop through the opperands and get the result and evaluate if it equal to what is in the results array
 

🛠️ IMPLEMENT
function checkArithmericExpressions(operands1, operators, operands2, results) // returns an array of booleans
